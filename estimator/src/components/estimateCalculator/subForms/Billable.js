 ...
 * Note: this boolean is a string because the backend
 * can't recognize literal bools as of spring 2024.
 *
  ...
  useEffect(() => {
    if (display) {
      determineBackgroundColor(
        document.getElementById(importID),
        props.billable.data.autoImport
      );
    }
  }, [display]);
  ...
  return (
    <div className="billableWrapper" ref={wrapperRef} id={props.index}>
      ...
      <div className="inputsWrapper">
        <div className="section">{props.billable.data.name}</div>
        {/**Show the price of the billable item */}
        <div className="section">${props.billable.data.price}</div>
        {props.billable.data.inputs !== undefined &&
          Object.keys(props.billable.data.inputs).map((key) => (
      ...
      <div className="buttonSection">
        {props.insertBillable !== undefined ? (
          !props.billable.imported ? (
            ...
            <div className="mockBtn">Imported</div>
          )
        ) : null}
            ...
            >
              ...
              <img
                ...
                onClick={() => {
                  ...
                  axios
                    .put(
                      "/api/library?_id=" + newBillable.data._id.$oid,
                      newBillable.data
                    )
                    .then((respone) => {
                      console.log(respone);
          ...
          <div className="optionsMenu">
            ...
            <div
              ...
              onClick={() => {
                ...
                props.billable.data.autoImport = toggle(
                  props.billable.data.autoImport
                );
                ...
                if (
                  !props.billable.imported &&
                  props.insertBillable !== undefined &&
                  props.billable.data.autoImport === "true"
                ) {
                  props.insertBillable(props.billable.data);
                  props.billable.imported = true;
                }
            ...
            >
              Auto Import
              <div className="boxTick" id={importID}></div>
            </div>
            {/*Price scan button */}
            <div
